# Lesson_10 : Utilisation d'un détecteur d'humidité/température
...
## [Sensor_1.py](Sensor_1.py) est un programme qui lit et affiche la valeur du potentiomètre
...
## [Sensor_2.py](Sensor_2.py) est un programme qui allume une led en fonction de la valeur du potentiomètre (ici supérieur a 30000)
